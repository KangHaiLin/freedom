...
def init_market_data_sources() -> None:
    ...
    try:
        ...
        logger.info(
            f"行情数据源AKShare注册成功，优先级={ds_config['akshare_priority']}, 权重={ds_config['akshare_weight']}"
        )
    ...
    if ds_config["tushare_api_key"]:
        ...
        try:
            ...
            logger.info(
                f"行情数据源Tushare注册成功，优先级={ds_config['tushare_priority']}, 权重={ds_config['tushare_weight']}"
            )
        except Exception as e:
    ...
    if ds_config["joinquant_api_key"]:
        ...
        try:
            ...
            logger.info(
                f"行情数据源JoinQuant注册成功，优先级={ds_config['joinquant_priority']}, 权重={ds_config['joinquant_weight']}"
            )
        except Exception as e:
...
def init_fundamentals_data_sources() -> None:
    ...
    try:
        ...
        logger.info(
            f"基本面数据源AKShare注册成功，优先级={ds_config['akshare_priority']}, 权重={ds_config['akshare_weight']}"
        )
    except Exception as e:
    ...
    if ds_config["tushare_api_key"]:
        ...
        try:
            ...
            logger.info(
                f"基本面数据源Tushare注册成功，优先级={ds_config['tushare_priority']}, 权重={ds_config['tushare_weight']}"
            )
        except Exception as e:
    ...
    if ds_config["wind_api_key"]:
        ...
        try:
            ...
            logger.info(
                f"基本面数据源Wind注册成功，优先级={ds_config['wind_priority']}, 权重={ds_config['wind_weight']}"
            )
        except Exception as e:
    ...
    if ds_config["joinquant_api_key"]:
        ...
        try:
            ...
            logger.info(
                f"基本面数据源JoinQuant注册成功，优先级={ds_config['joinquant_priority']}, 权重={ds_config['joinquant_weight']}"
            )
        except Exception as e:
