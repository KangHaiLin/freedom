...
from .base_monitor import AlertLevel, MonitorResult
...
class AlertService:
    ...
    def __init__(self, config: Dict = None):
        ...
        self.alert_template = self.config.get(
            "template",
            """
...
详细信息：{details}
    ...
    def send_alert(
        self, result: MonitorResult, channels: Optional[List[str]] = None, receiver: Optional[List[str]] = None
    ) -> bool:
        """
        发送告警
        Args:
    ...
    def _send_wecom_alert(self, result: MonitorResult, receiver: Optional[List[str]] = None):
        ...
        message = self._format_alert_message(result)
        data = {"msgtype": "text", "text": {"content": message, "mentioned_list": mentioned_list}}
    ...
    def _send_dingtalk_alert(self, result: MonitorResult, receiver: Optional[List[str]] = None):
        ...
        message = self._format_alert_message(result)
        data = {"msgtype": "text", "text": {"content": message}, "at": {"atMobiles": at_mobiles, "isAtAll": is_at_all}}
    ...
    def _send_webhook_alert(self, result: MonitorResult):
        ...
        data = {"alert": result.to_dict(), "timestamp": DateTimeUtils.now_str()}
