...
class TestClickHouseStorage:
    ...
    def test_write_list_dict(self):
        ...
        with patch("clickhouse_driver.Client") as mock_client_class:
            ...
            data = [{"symbol": "000001.SZ", "price": 10.0}, {"symbol": "600000.SH", "price": 15.0}]
    ...
    def test_execute_sql_select(self):
        ...
        with patch("clickhouse_driver.Client") as mock_client_class:
            mock_client = mock_client_class.return_value
            # 模拟返回带列信息的结果
            mock_client.execute.return_value = ([(10.0, "000001.SZ")], [("price", "Float64"), ("symbol", "String")])
            storage.connection = mock_client
    ...
    def test_create_table(self):
        ...
        with patch("clickhouse_driver.Client") as mock_client_class:
            ...
            schema = {"symbol": "String", "time": "DateTime", "price": "Float64"}
...
class TestPostgreSQLStorageAdditional:
    ...
    def test_write_list_data(self):
        ...
        data = [{"stock_code": "000001.SZ", "price": 10.0}, {"stock_code": "600000.SH", "price": 15.0}]
    ...
    def test_create_table(self):
        ...
        schema = {"id": "SERIAL", "stock_code": "VARCHAR(20)", "price": "NUMERIC(10,2)"}
...
class TestStorageManager:
    ...
    @patch.dict(
        "common.config.settings.STORAGE_CONFIGS",
        {
            "postgresql": {
                "type": "postgresql",
                "host": "localhost",
    ...
    def test_init(self):
        """测试初始化"""
        with (
            patch("data_management.data_storage.redis_storage.RedisStorage.connect"),
