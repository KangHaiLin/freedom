...
def test_align_time_range_intersection():
    ...
    # 数据集1: 1-5日
    df1 = pd.DataFrame({"trade_date": pd.date_range("2024-01-01", "2024-01-05"), "value": [1, 2, 3, 4, 5]})

    # 数据集2: 3-7日
    df2 = pd.DataFrame({"trade_date": pd.date_range("2024-01-03", "2024-01-07"), "value": [3, 4, 5, 6, 7]})
...
def test_align_time_range_union():
    ...
    df1 = pd.DataFrame({"trade_date": pd.date_range("2024-01-01", "2024-01-03"), "value": [1, 2, 3]})

    df2 = pd.DataFrame({"trade_date": pd.date_range("2024-01-03", "2024-01-05"), "value": [3, 4, 5]})
